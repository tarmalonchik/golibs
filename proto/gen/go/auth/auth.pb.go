...
type AuthOption struct {
	...
	Type          AuthType               `protobuf:"varint,1,opt,name=type,proto3,enum=AuthType" json:"type,omitempty"`
...
var (
	// optional AuthOption auth = 50001;
...
const file_auth_auth_proto_rawDesc = "" +
	"\n" +
	"\x0fauth/auth.proto\x1a google/protobuf/descriptor.proto\"+\n" +
	"\n" +
	"AuthOption\x12\x1d\n" +
	"\x04type\x18\x01 \x01(\x0e2\t.AuthTypeR\x04type*\x1f\n" +
	"\bAuthType\x12\b\n" +
	"\x04NONE\x10\x00\x12\t\n" +
	"\x05BASIC\x10\x01:A\n" +
	"\x04auth\x12\x1e.google.protobuf.MethodOptions\x18ц\x03 \x01(\v2\v.AuthOptionR\x04authB8Z6github.com/tarmalonchik/golibs/proto/gen/go/auth;protob\x06proto3"
...
var file_auth_auth_proto_goTypes = []any{
	...
	(*AuthOption)(nil),                 // 1: AuthOption
	(*descriptorpb.MethodOptions)(nil), // 2: google.protobuf.MethodOptions
}
var file_auth_auth_proto_depIdxs = []int32{
	0, // 0: AuthOption.type:type_name -> AuthType
	2, // 1: auth:extendee -> google.protobuf.MethodOptions
	1, // 2: auth:type_name -> AuthOption
